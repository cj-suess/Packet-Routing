...
HOSTS=("grouper" "denver" "moscow" "tuna" "venus" "madrid" "mars" "beijing" "turbot" "cod" "leek" "lettuce" "okra" "berlin" "yam" "cairo") # "venus" "madrid" "mars" "beijing" "turbot" "onion" "leek" "lettuce" "okra" "berlin" "yam" "cairo"
